...
//  */
// import { BigDecimal, UniswapBondingCurveContract, User } from "generated";
// import {
...
// import { ONE_ETHER_DECIMAL, TOKEN_TOTAL_SUPPLY_DECIMAL } from "./helpers/constants";
// import { fetchUniswapBondingCurveDetails } from "./helpers/uniswapBondingCurve";


// UniswapBondingCurveContract.LogBuy.handler(async ({ event, context }) => {
...
//   let currentPrice = bondingCurveDetails.ethReserve.div(
//     bondingCurveDetails.tokenReserve
//   );
...
// UniswapBondingCurveContract.LogSell.handler(async ({ event, context }) => {
...
// UniswapBondingCurveContract.BondingCurveComplete.handler(
//   async ({ event, context }) => {
//     let bondingCurveAddress = event.srcAddress;
//     let bondingCurveId = generateBondingCurveId(
//       event,
